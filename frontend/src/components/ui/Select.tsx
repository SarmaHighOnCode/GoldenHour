  ...
  return (
    <div className="space-y-1.5 w-full relative">
      ...
      <div className="relative">
        <select
          id={id}
          className={`w-full h-14 bg-white border-2 border-slate-200 focus:border-ink rounded-xl pl-4 pr-10 text-sm font-bold text-ink focus:outline-none focus:ring-4 focus:ring-slate-500/10 appearance-none cursor-pointer transition-all ${
